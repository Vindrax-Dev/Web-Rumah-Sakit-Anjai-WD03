...
<html lang="en">
 ...
 <div class="main-panel">
          <div class="content-wrapper">
              ...
              <div class="col-md-12 grid-margin">
                <div class="row">
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Berikut Riwayat Pasien Anda</h6>
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
            <?php
// Mengambil ID dokter dari session
$id_dokter = $_SESSION['id_user']; 

// Query untuk mengambil data pasien dengan nomor antrian 0 dan sesuai dengan id_dokter
$query = "
    SELECT 
        dp.id AS no,
        ps.nama AS pasien,
    ...
    WHERE 
        dp.no_antrian = 0 AND jp.id_dokter = '$id_dokter'
    GROUP BY 
        dp.id_pasien
";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "
                                <tr>
                                    ...
                                    <td>{$row['no_rm']}</td>
                                    <td><a href='riwayatpasien.php?id={$row['no']}' class='btn btn-warning'>Detail</a></td>
                                </tr>
                            ";
                            $no++;
                        }

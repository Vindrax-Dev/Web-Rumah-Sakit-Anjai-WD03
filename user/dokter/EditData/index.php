            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                        $sql_Dokter = mysqli_query($con,"SELECT * FROM dokter WHERE id = '$_SESSION[id_user]'") or die (mysqli_error($con));
                    ...
                    <form action="proses.php" method="post" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text"name="noHP" class="form-control" id="noHP" placeholder="<?=$data['no_hp']?>">
                      </div>
                      <div class="form-group">
                        <label for="id_poli">ID Poli</label>
                        <input type="text"name="id_poli" class="form-control" id="id_poli" placeholder="<?=$data['id_poli']?>">
                      </div>
